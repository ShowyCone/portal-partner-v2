...
const ProviderLogin: React.FC = () => (
  <section className='flex flex-col md:flex-row bg-white min-h-[calc(100vh-5rem)] justify-center items-center gap-8 md:gap-12 p-4 sm:p-8 md:p-12'>
    ...
    <motion.div
      className='w-full h-full md:w-auto p-4 sm:p-6 md:p-8 flex flex-col justify-center items-center gap-4 sm:gap-6 max-w-full md:max-w-2/5'
      initial='hidden'
      animate='visible'
    ...
    >
      ...
      <div className='h-48 sm:h-64 md:h-full bg-gray-300 rounded-lg flex items-center justify-center overflow-hidden w-full'>
        <Image
          src='/rwainc.webp'
          alt='RWA Inc Logo'
          width={400}
